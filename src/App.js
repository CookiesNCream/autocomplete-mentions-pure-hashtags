...
/* Stores plugins to be parsed to the Editor */
const plugins = [
  hashtagPlugin,
  mentionPlugin,
];

const text = `#hashtag: I am having a blast. This is so #awesome and #cool :D @linda …
`;
...
export default class App extends React.Component { /* The App React component is rendered via index.js */
  ...
  onSearchChange = ({ value }) => {
    this.setState({
      suggestions: defaultSuggestionsFilter(value, mentions), /* Triggers a match string */
    });
  };
    ...
    return (
      ...
      <div className="App">
        ...
        <div className="App-header">
          ...
          <h2>Autocomplete Mentions and Pure Hashtags using Draft.js</h2>
